export const COMPANY_INFO = {
  name: "moccet",
  tagline:
    "We match the perfect AI agents with human experts to complete knowledge work 10x faster and 70% cheaper.",
  email: "info@moccet.com",
};

export const TRUSTED_COMPANIES = ["TheWellness", "Nuqoot"];
...
export const CASE_STUDIES = [
  {
    ...
    type: "Mobile App",
    description:
      "Location-based app for finding available tables at local coffee shops, complete with real-time availability and booking system.",
    deliveryTime: "48 hrs",
    costSavings: "70%",
  },
  {
    ...
    description:
      "Fitness class discovery and booking platform with personalized recommendations, secure payment processing, and calendar integration.",
    deliveryTime: "5 days",
    costSavings: "65%",
  },
  {
    ...
    description:
      "Secure healthcare data API with comprehensive documentation, authentication system, and FHIR-compliant endpoints.",
    deliveryTime: "1 week",
    costSavings: "60%",
  },
];
...
export const MAIN_STATS = [
  {
    number: "10×",
    label: "Faster project delivery compared to traditional methods",
  },
  { number: "70%", label: "Average cost savings for our clients" },
  { number: "100%", label: "Client satisfaction on delivered projects" },
];
...
export const FOOTER_SECTIONS = [
  {
    title: "Product",
    links: ["Features", "AI Agents", "Integrations", "API Reference"],
  },
  {
    title: "Resources",
