...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '5,000+ SBA questions for UKMLA AKT. Expert explanations, unlimited mock exams. For UK medical students & IMGs.',
    url: 'https://www.medbanqs.com/ukmla-akt',
    type: 'website',
    images: [
      {
        url: 'https://www.medbanqs.com/ukmla-akt-og.png',
        width: 1200,
        height: 630,
        alt: 'UKMLA AKT Preparation with MedBanqs',
      }
    ],
  },
  twitter: {
