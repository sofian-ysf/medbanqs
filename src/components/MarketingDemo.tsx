...
// Global demo manager for Marketing
class MarketingDemoManager {
  ...
  private async startDemo(): Promise<void> {
    ...
    const messages: TeamMember[] = [
      {
        type: "client",
        text: "Need to launch a viral campaign for our new SaaS product",
        delay: 1000,
      },
      {
        type: "ai",
        ...
        expertise: [
          "Generated 100M+ social media posts",
          "Expert in viral content patterns",
          "Specialized in multi-platform campaigns",
        ],
        text: "Analyzing trending topics and your brand voice. I'll create 50 variations of viral-ready content across all platforms.",
        delay: 2500,
      },
      {
        type: "human",
        ...
        expertise: [
          "Led campaigns for 20+ Fortune 500 brands",
          "Expert in brand storytelling and viral marketing",
          "12 years in creative strategy",
        ],
        text: "Perfect! I'll refine the creative direction and ensure brand consistency across all touchpoints.",
        delay: 2800,
      },
      {
        type: "client",
        text: "How do we ensure maximum reach and engagement?",
        delay: 2000,
      },
      {
        type: "ai",
        ...
        expertise: [
          "Optimized $50M+ in ad spend",
          "Specializes in audience targeting",
          "Auto-manages bid strategies",
        ],
        text: "Already identified your high-converting audiences. I'll launch targeted campaigns and optimize budgets in real-time for maximum ROI.",
        delay: 2500,
      },
      {
        type: "client",
        text: "Great! When can we see the first results?",
        delay: 1800,
      },
      {
        type: "ai",
        ...
        text: "First batch of content goes live in 1 hour. I'll monitor engagement patterns and auto-generate variations based on performance.",
        delay: 2200,
      },
    ];
