...
// Global demo manager for Healthcare
class HealthcareDemoManager {
  ...
  private async startDemo(): Promise<void> {
    ...
    const messages: TeamMember[] = [
      {
        type: "client",
        text: "Need HIPAA-compliant patient management system with real-time monitoring",
        delay: 1000,
      },
      {
        type: "ai",
        sender: "HealthcareAI",
        role: "Medical Data Agent",
        expertise: [
          "Processed 10M+ patient records securely",
          "Expert in HIPAA compliance and medical standards",
          "Specialized in real-time health monitoring",
        ],
        text: "Perfect! I'll design encrypted patient data flows with real-time vital monitoring. Full HIPAA compliance with audit trails included.",
        delay: 2500,
      },
      {
        type: "human",
        ...
        expertise: [
          "15+ years in healthcare IT systems",
          "Expert in clinical workflows and compliance",
          "Led digital transformation at 3 hospitals",
        ],
        text: "Excellent approach! I'll ensure the clinical workflows align with actual hospital operations and staff needs.",
        delay: 2800,
      },
      {
        type: "client",
        text: "How do we handle emergency alerts and critical readings?",
        delay: 2000,
      },
      {
        type: "ai",
        sender: "AlertSystem",
        role: "Critical Care Agent",
        expertise: [
          "Monitored 500k+ critical events",
          "Specializes in emergency response systems",
          "Auto-escalation and notification protocols",
        ],
        text: "Real-time anomaly detection with instant alerts to on-call staff. Smart escalation based on severity and response times.",
        delay: 2500,
      },
      {
        type: "client",
        text: "Perfect! When can we start the pilot program?",
        delay: 1800,
      },
      {
        type: "ai",
        ...
        text: "Core system with patient monitoring ready in 2 weeks. I'll handle all compliance documentation and security audits automatically.",
        delay: 2200,
      },
    ];
