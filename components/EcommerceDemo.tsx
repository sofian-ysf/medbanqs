...
// Global demo manager for Progress Tracker
class EcommerceDemoManager {
  ...
  private async startDemo(): Promise<void> {
    ...
    const messages: TeamMember[] = [
      {
        type: "client",
        text: "How am I doing in my UKMLA preparation? I feel like I'm not improving",
        delay: 1000,
      },
      {
        type: "ai",
        ...
        expertise: [
          "Analyzed 1M+ student performance patterns",
          "Predicts exam scores with 95% accuracy",
          "Identifies knowledge gaps in real-time",
        ],
        text: "I've analyzed your last 500 questions. Overall accuracy: 72% (up from 65% last month). Main weakness: Pharmacology at 58%. Strongest: Anatomy at 85%.",
        delay: 2500,
      },
      {
        type: "human",
        sender: "Dr. James Wilson",
        role: "UKMLA Performance Coach",
        expertise: [
          "Coached 200+ students to top decile scores",
          "Expert in exam strategy and time management",
          "Former medical school admissions advisor",
        ],
        text: "Good progress! Your trend is positive. Let's focus on pharmacology - I see you struggle with drug interactions. I'll create targeted exercises.",
        delay: 2800,
      },
      {
        type: "client",
        text: "Which specific topics in pharmacology need the most work?",
        delay: 2000,
      },
      {
        type: "ai",
        ...
        expertise: [
          "Maps knowledge gaps to exam topics",
          "Tracks improvement velocity per subject",
          "Predicts time needed for mastery",
        ],
        text: "Top 3 gaps: 1) Drug interactions (45% accuracy), 2) Pharmacokinetics (52%), 3) Adverse effects (58%). You need ~15 hours to reach 80% in these areas.",
        delay: 2500,
      },
      {
        type: "client",
        text: "Can you show me my progress trend over time?",
        delay: 1800,
      },
      {
        type: "ai",
        ...
        text: "📈 Week 1: 65%, Week 2: 68%, Week 3: 70%, This week: 72%. At this rate, you'll reach your target 85% in 6 weeks. Keep it up!",
        delay: 2200,
      },
    ];
