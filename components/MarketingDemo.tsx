...
// Global demo manager for Clinical Tutor
class MarketingDemoManager {
  private static instance: MarketingDemoManager;
  ...
  static getInstance(): MarketingDemoManager {
    if (!MarketingDemoManager.instance) {
      MarketingDemoManager.instance = new MarketingDemoManager();
    }
    return MarketingDemoManager.instance;
  }
  ...
  private async startDemo(): Promise<void> {
    ...
    const messages: TeamMember[] = [
      {
        type: "client",
        text: "I'm confused about this patient case - 45yo man with chest pain and elevated troponin",
        delay: 1000,
      },
      {
        type: "ai",
        ...
        expertise: [
          "Analyzed 100,000+ clinical cases",
          "Evidence-based differential diagnosis",
          "NICE guidelines integration",
        ],
        text: "Let's work through this systematically. What's his ECG showing? With elevated troponin, we need to consider ACS, PE, myocarditis. What other clinical features does he have?",
        delay: 2500,
      },
      {
        type: "human",
        sender: "Dr. Michael Thompson",
        role: "Senior Clinical Tutor",
        expertise: [
          "15 years emergency medicine experience",
          "UKMLA examiner and question writer",
          "Expert in clinical decision making",
        ],
        text: "Good approach! Remember the UKMLA loves testing risk stratification. Let's calculate his GRACE score and discuss immediate management per NICE CG95.",
        delay: 2800,
      },
      {
        type: "client",
        text: "ECG shows ST elevation in leads II, III, aVF. What's my next step?",
        delay: 2000,
      },
      {
        type: "ai",
        sender: "GuidelinesAI",
        role: "Clinical Guidelines Expert",
        expertise: [
          "All NICE guidance integrated",
          "Real-time protocol updates",
          "Drug interaction checker",
        ],
        text: "Inferior STEMI confirmed. Immediate dual antiplatelet therapy (aspirin 300mg + ticagrelor 180mg), arrange primary PCI within 120 minutes. Also check for RV involvement with V4R.",
        delay: 2500,
      },
      {
        type: "client",
        text: "What complications should I watch for with inferior MI?",
        delay: 1800,
      },
      {
        type: "ai",
        ...
        text: "Key complications: bradyarrhythmias (40% risk), RV infarction (check JVP), and papillary muscle dysfunction. Monitor closely and have atropine ready. This is a high-yield UKMLA topic!",
        delay: 2200,
      },
    ];
      ...
      <div className="flex items-start gap-3 mb-3">
        <div
          className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm transition-all duration-300 ${
            isAI ? "bg-[#FAE3B9] text-black" : "bg-black text-white"
          }`}
        >
          {isAI ? "✦" : initials}
        </div>
...
const Message: React.FC<{ message: TeamMember }> = ({ message }) => {
  ...
  const isAI =
    message.sender?.includes("AI") || message.sender?.includes("Optimizer");
...
const MarketingDemo: React.FC = () => {
  ...
  useEffect(() => {
    const demoManager = MarketingDemoManager.getInstance();
      ...
      <div className="w-64 h-[520px] bg-white rounded-[24px] border-4 border-black shadow-2xl overflow-hidden relative">
        ...
        <div className="bg-white border-b border-gray-200 p-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="w-7 h-7 rounded-full bg-[#FAE3B9] flex items-center justify-center">
              <span className="text-black text-xs font-bold">✦</span>
            </div>
            <div>
        ...
        <div className="p-3 bg-white border-t border-gray-200">
          <div className="flex items-center gap-2 px-3 py-2 bg-gray-50 border border-gray-200 rounded-2xl">
            ...
            />
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-full bg-[#FAE3B9] flex items-center justify-center">
                <span className="text-black text-xs font-bold">↑</span>
              </div>
            </div>
          </div>
