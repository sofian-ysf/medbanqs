...
// Global demo manager for Study Assistant
class HealthcareDemoManager {
  private static instance: HealthcareDemoManager;
  ...
  static getInstance(): HealthcareDemoManager {
    if (!HealthcareDemoManager.instance) {
      HealthcareDemoManager.instance = new HealthcareDemoManager();
    }
    return HealthcareDemoManager.instance;
  }
  ...
  private async startDemo(): Promise<void> {
    ...
    const messages: TeamMember[] = [
      {
        type: "client",
        text: "I need help preparing for my UKMLA exam - I'm struggling with cardiology topics",
        delay: 1000,
      },
      {
        type: "ai",
        sender: "StudyAI",
        role: "UKMLA Study Assistant",
        expertise: [
          "Analyzed 50,000+ UKMLA past questions",
          "98% student pass rate with AI guidance",
          "Personalized learning paths for each topic",
        ],
        text: "I've analyzed your practice test results. You're scoring 65% in cardiology. Let's focus on ECG interpretation and acute coronary syndromes first - these are high-yield topics.",
        delay: 2500,
      },
      {
        type: "human",
        sender: "Dr. Sarah Chen",
        role: "UKMLA Expert Tutor",
        expertise: [
          "Former UKMLA examiner for 8 years",
          "Taught 500+ medical students",
          "Specializes in clinical reasoning skills",
        ],
        text: "Great strategy! I'll create targeted case studies for ACS management. Let's also practice NICE guideline applications - they love those in the exam.",
        delay: 2800,
      },
      {
        type: "client",
        text: "Can you create a study schedule for the next 3 weeks?",
        delay: 2000,
      },
      {
        type: "ai",
        ...
        expertise: [
          "Created 10,000+ personalized study plans",
          "Tracks optimal revision timing",
          "Adapts based on your progress",
        ],
        text: "Created your 3-week plan: Week 1: Cardiology & Respiratory, Week 2: Pharmacology & Emergency Medicine, Week 3: Mock exams & weak areas. Daily 2-hour sessions with spaced repetition.",
        delay: 2500,
      },
      {
        type: "client",
        text: "Perfect! Can you add some ECG practice questions?",
        delay: 1800,
      },
      {
        type: "ai",
        ...
        text: "Added 20 ECG interpretation questions to today's session. Starting with basic rhythms, then progressing to STEMIs and complex arrhythmias. Each has detailed explanations and clinical context.",
        delay: 2200,
      },
    ];
      ...
      <div className="flex items-start gap-3 mb-3">
        <div
          className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm transition-all duration-300 ${
            isAI
              ? "bg-gradient-to-br from-[#ABC09F] to-[#ABC09F] text-black"
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <span
              className={`px-2 py-0.5 text-xs font-bold rounded-full ${
                isAI ? "bg-[#ABC09F] text-black" : "bg-black text-white"
              }`}
            >
              {isAI ? "AI" : "HUMAN"}
            </span>
...
const Message: React.FC<{ message: TeamMember }> = ({ message }) => {
  ...
  const isAI =
    message.sender?.includes("AI") || message.sender?.includes("System");
...
const HealthcareDemo: React.FC = () => {
  ...
  useEffect(() => {
    const demoManager = HealthcareDemoManager.getInstance();
      ...
      <div className="w-64 h-[520px] bg-white rounded-[24px] border-4 border-black shadow-2xl overflow-hidden relative">
        ...
        <div className="bg-white border-b border-gray-200 p-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="w-7 h-7 rounded-full bg-[#ABC09F] flex items-center justify-center">
              <span className="text-black text-xs font-bold">✦</span>
            </div>
            <div>
        ...
        <div className="p-3 bg-white border-t border-gray-200">
          <div className="flex items-center gap-2 px-3 py-2 bg-gray-50 border border-gray-200 rounded-2xl">
            ...
            />
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-full bg-[#ABC09F] flex items-center justify-center">
                <span className="text-black text-xs font-bold">↑</span>
              </div>
            </div>
          </div>
